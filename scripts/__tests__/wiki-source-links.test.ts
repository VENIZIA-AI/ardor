...
// disposable, unrelated to the outer ARDOR checkout.
const makeTrackedRepo = (): string => {
  ...
  writeFixture({
    ...
    content: [
      '# Doc',
      '',
      'Tracked: https://github.com/VENIZIA-AI/ardor/blob/main/packages/x/y.ts',
      'Untracked: https://github.com/VENIZIA-AI/ardor/blob/main/packages/x/missing.ts',
      'Directory: https://github.com/VENIZIA-AI/ardor/tree/main/packages/x',
