...
name: ignis-skills
description: >
  ARDOR project skills and shared agent settings for Claude Code and compatible agents. Skills are
  thin wrappers over the canonical knowledge in .agents/knowledge - they point at concepts, they do
  not duplicate them.
author: Venizia
---

# ARDOR project skills and shared agent settings

Project-specific assets for working on the ARDOR monorepo. The rules themselves live in
